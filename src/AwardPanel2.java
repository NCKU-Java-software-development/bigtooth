...
public class AwardPanel2 extends JPanel {
    ...
    public void healbigtooth(Level2 panel) {
        panel.heal();
    }

    public void speed(Level2 panel) {
        panel.IncreaseSpeed();
    }

    public void attack(Level2 panel) {
    ...
    AwardPanel2(Level2 gameFrame, ButtonPressedListener listener) {
